...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userSettings.usePagination && (page < 1 || page > data.pageCount)) {
        ...
        return helpers_1.default.redirect(res, `/unread?${querystring_1.default.stringify(webQuery)}`);
    }
...
exports.get = get;
const unreadTotal = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = req.query.filter || '';
    try {
        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call
